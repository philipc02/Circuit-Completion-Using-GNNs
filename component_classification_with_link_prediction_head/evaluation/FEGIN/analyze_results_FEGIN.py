...
def load_results(results_dir='hyperparameter_search_ltspice_demos_round_3'):
...
def create_comparison_chart(best_results, output_dir='analysis'):
    ...
    bars = ax1.bar(x_pos, f1_scores, capsize=10, alpha=0.8, color=['#3070b3', '#d99208', '#9b468d', '#7d922a'])
    ...
    print("Comparison chart saved to analysis_ltspice_demos_round_3/representation_comparison.png")
...
def main():
    output_dir = 'analysis_ltspice_demos_round_3'
    os.makedirs(output_dir, exist_ok=True)
    
    print("Loading results...")
    all_results, best_results = load_results('hyperparameter_search_ltspice_demos_round_3')
