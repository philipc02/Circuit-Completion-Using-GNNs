...
def load_results(results_dir='hyperparameter_search_ltspice_demos_round_2'):
...
def create_comparison_chart(best_results, output_dir='analysis'):
    ...
    print("Comparison chart saved to analysis_ltspice_demos_round_2/representation_comparison.png")
...
def main():
    output_dir = 'analysis_ltspice_demos_round_2'
    os.makedirs(output_dir, exist_ok=True)
    
    print("Loading results...")
    all_results, best_results = load_results('hyperparameter_search_ltspice_demos_round_2')
